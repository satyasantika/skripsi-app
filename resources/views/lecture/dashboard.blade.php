    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h3>Ajuan Dosen Pembimbing</h3>
                    <hr>
                    @forelse ($guides as $guide)
                    <div class="row mb-3">
                        <div class="col-md-auto">
                            <span class="btn btn-sm btn-outline-secondary">Pembimbing {{ $guide->guide_group->guide_1 == 0 ? 2 : 1 }}</span>
                            <span class="h4">{{ $guide->submission->user->name }}</span>
                            <a href="https://wa.me/62{{ $guide->submission->user->phone }}">
